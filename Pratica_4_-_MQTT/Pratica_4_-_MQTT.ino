...
#define TOPICO_SUBSCRIBE_P1 "aulacefet/led"     //tópico MQTT de escuta luz 1

                                                   
#define ID_MQTT "luma_chen"     //id mqtt (para identificação de sessão)
...
void reconnectMQTT() 
{
    while (!MQTT.connected()) 
    {
        ...
        {
            Serial.println("Falha ao reconectar no broker."); //broker é o servidor
